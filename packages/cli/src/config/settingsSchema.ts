...
const SETTINGS_SCHEMA = {
  ...
  katharine: {
    ...
    requiresRestart: true,
    default: {},
    description: 'Settings for Katharine personal assistant mode.',
    showInDialog: false,
    properties: {
      enabled: {
        type: 'boolean',
        label: 'Enable Katharine Mode',
        category: 'Katharine',
        requiresRestart: true,
        default: false,
        description: 'Enable Katharine personal assistant interface and features.',
        showInDialog: true,
      },
      theme: {
        type: 'object',
        ...
        requiresRestart: false,
        default: {},
        description: 'Katharine theme settings.',
        showInDialog: false,
        properties: {
          useVioletTheme: {
            type: 'boolean',
            label: 'Use Violet Theme',
            category: 'Katharine',
            requiresRestart: false,
            default: true,
            description: 'Use violet color theme when Katharine mode is enabled.',
            showInDialog: true,
          },
          persistTheme: {
            type: 'boolean',
            ...
            requiresRestart: false,
            default: true,
            description: 'Persist violet theme across sessions when Katharine is enabled.',
            showInDialog: true,
          },
        },
      },
      assistant: {
        ...
        requiresRestart: false,
        default: {},
        description: 'Assistant behavior settings.',
        showInDialog: false,
        properties: {
          personality: {
            type: 'enum',
            ...
            requiresRestart: false,
            default: 'friendly',
            description: 'The personality style for Katharine assistant responses.',
            showInDialog: true,
            options: [
          ...
          confirmationLevel: {
            ...
            requiresRestart: false,
            default: 'sensitive',
            description: 'When to ask for confirmation before executing workflows.',
            showInDialog: true,
            options: [
              { value: 'always', label: 'Always' },
              { value: 'sensitive', label: 'Sensitive Operations Only' },
          ...
          autoExecuteWorkflows: {
            ...
            requiresRestart: false,
            default: false,
            description: 'Automatically execute simple workflows without confirmation.',
            showInDialog: true,
          },
        },
      },
      browser: {
        ...
        requiresRestart: true,
        default: {},
        description: 'Browser extension and automation settings.',
        showInDialog: false,
        properties: {
          extensionEnabled: {
            type: 'boolean',
            ...
            requiresRestart: true,
            default: false,
            description: 'Enable browser extension integration for web automation.',
            showInDialog: true,
          },
          websocketPort: {
            type: 'number',
            ...
            requiresRestart: true,
            default: 8765,
            description: 'Port for WebSocket communication with browser extension.',
            showInDialog: false,
          },
          captureScreenshots: {
            type: 'boolean',
            ...
            requiresRestart: false,
            default: false,
            description: 'Allow browser extension to capture screenshots for context.',
            showInDialog: true,
          },
        },
      },
      privacy: {
        ...
        properties: {
          privacyMode: {
            ...
            requiresRestart: false,
            default: true,
            description: 'Enable privacy mode to limit data collection and storage.',
            showInDialog: true,
          },
          storeConversations: {
            type: 'boolean',
            ...
            requiresRestart: false,
            default: true,
            description: 'Store conversation history for learning and context.',
            showInDialog: true,
          },
          encryptStorage: {
            type: 'boolean',
            ...
            requiresRestart: true,
            default: true,
            description: 'Encrypt stored conversation data and preferences.',
            showInDialog: true,
          },
        },
      },
